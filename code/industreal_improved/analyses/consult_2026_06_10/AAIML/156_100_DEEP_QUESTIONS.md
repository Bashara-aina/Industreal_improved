...
- Post_gelu: -1.0 to -1.4 (dead) → +4608 (alive) — auditable from committed log  (commit )
...
- Activations went from dead (-1.0) to alive (+4608) with LeakyReLU — auditable from committed log  (commit )
