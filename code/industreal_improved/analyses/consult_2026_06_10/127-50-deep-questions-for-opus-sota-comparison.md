...
- `SOTA_STATUS.md:16-17` — Our PSR: 0.7217 (global) / 0.7499 (per-comp optimal)
...
- `SOTA_STATUS.md:16-17` — PSR F1=0.7217/0.7499 near STORM-PSR 0.901 (different paradigm)
