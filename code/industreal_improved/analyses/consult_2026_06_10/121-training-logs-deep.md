...
---
## Section 19: Fable6 Deep Analysis

Fable6 is the largest single log file (7.5 MB, 46,625 lines) and the first successful multi-epoch training run with all 4 heads on the 5060 Ti. It established the config baseline for all subsequent runs.

### 19.1 Fable6 Overview

- Log size: 7.5 MB, 46,625 lines
- Active heads: ALL 4 (DET, POSE, ACT, PSR)
- Total epochs started: 4 unique epochs (epochs 2-5)
- Train blocks: 3
- Validation blocks: 1
- DET_PROBES: 500 (428 LOCALIZING, 72 TOTAL COLLAPSE)
- LOCALIZING rate: 85.6%

### 19.2 Fable6 Epoch Timeline

| Epoch | Timestamp (start) | Notes |
|---|---|---|

### 19.3 Fable6 vs rf_stages Comparison

| Metric | Fable6 | rf_stages |
|---|---|---|
| Log Size | 7.5 MB | 3.4 MB |
| Lines | 46,625 | 49,831 |
| DET_PROBES | 500 | 4,210 |
| LOCALIZING rate | 85.6% | 68.5% |
| Validation events | varies | 5 |
| Epochs attempted | multiple | 0-17 |

rf_stages ran longer (26h vs ~11h for fable6) and has 8x more DET_PROBES, suggesting it performed more validation iterations per epoch.

### 19.4 Phase A/B/C Ablation Details

- **Phase A** (phase_A_5060ti): 24 KB, GPU=NVIDIA GeForce RTX 3060, Ablation: TRAIN_DET=True  TRAIN_HEAD_POSE=True  TRAIN_ACT=False  TRAIN_PSR=False
  - Train summaries: 0, Val blocks: 0, DET_PROBES: 0
- **Phase B** (phase_B_5060ti): 1379 KB, GPU=NVIDIA GeForce RTX 5060 Ti, Ablation: TRAIN_DET=True  TRAIN_HEAD_POSE=True  TRAIN_ACT=True  TRAIN_PSR=False 
  - Train summaries: 0, Val blocks: 0, DET_PROBES: 0
- **Phase C** (phase_C_5060ti): 892 KB, GPU=NVIDIA GeForce RTX 5060 Ti, Ablation: TRAIN_DET=True  TRAIN_HEAD_POSE=True  TRAIN_ACT=True  TRAIN_PSR=True  
  - Train summaries: 0, Val blocks: 0, DET_PROBES: 0

### 19.5 Efficiency Monitor (phase_A_5060ti/swarm_monitor.log)

| Timestamp | VRAM Used | VRAM Reserved | GPU Util | Power | Temp |
|---|---|---|---|---|---|
| 13:17:52 [INFO] swarm.main: Initialized 20 agents for RF2 monitoring swarm |
| 13:17:52 [INFO] swarm.runner: Swarm runner started — 20 agents, interval=300s, o |
| 13:17:52 [INFO] swarm.runner: ================================================== |
| 13:17:52 [INFO] swarm.runner: Cycle 1 starting — gathering data... |
| 13:17:53 [INFO] swarm.runner: Epoch=0 step=None pid_alive=False |
| 13:17:53 [INFO] swarm.coordinator: Agent gate_tracker: 10 checks, worst=FAIL, 0. |
| 13:17:53 [INFO] swarm.coordinator: Agent probe_analyzer: 5 checks, worst=SKIP, 0 |
| 13:17:53 [INFO] swarm.coordinator: Agent head_health: 10 checks, worst=SKIP, 0.0 |
| 13:17:53 [INFO] swarm.coordinator: Agent loss_health: 7 checks, worst=SKIP, 0.0s |
| 13:17:53 [INFO] swarm.coordinator: Agent convergence: 6 checks, worst=WARN, 0.0s |
| 13:17:53 [INFO] swarm.coordinator: Agent data_pipeline: 10 checks, worst=WARN, 0 |

(First 10 lines shown. Full monitor log provides GPU utilization history.)

---
## Section 21: Miscellaneous Supporting Logs
...
---
## Section 22: Training Efficiency Metrics

### 22.1 Inference Speed
...
---
## Section 23: Conclusions and Recommendations

### 23.1 What is Working
...
**Report generated by:** Training Log Analyst Agent (automated analysis)

**Total metrics extracted:** thousands of loss values, validation scores, DET_PROBE entries, and per-class accuracy records.

**End of training log analysis.** 84 log files analyzed. 1972 lines of analysis.

### Appendix: Quick Reference

| Topic | Section |
|---|---|
| Complete file inventory | Section 1 |
| Training campaign phases | Section 2 |
| rf_stages hyperparameters | Section 3 |
| Loss curves per epoch | Section 4 |
| Validation metrics every epoch | Section 5 |
| Per-class activity accuracy | Section 6 |
| DET_PROBE verdict analysis | Section 7 |
| Kendall log-var evolution | Section 8 |
| Liveness gradient probes | Section 9 |
| Complete crash database | Section 10 |
| LR schedule details | Section 11 |
| PSR metric evolution | Section 12 |
| Head pose metrics | Section 13 |
| Config comparison table | Section 14 |
| NaN metrics inventory | Section 15 |
| Sampling distortion analysis | Section 16 |
| Checkpoint evaluations | Section 17 |
| Complete timeline | Section 18 |
| Fable6 deep analysis | Section 19 |
| Phase A/B/C ablation details | Section 19 |
| Miscellaneous logs | Section 21 |
| Efficiency metrics | Section 22 |
