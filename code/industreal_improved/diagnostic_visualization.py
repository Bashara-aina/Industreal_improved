...
output_dir = '/home/newadmin/swarm-bot/project/popw/working/code/industreal_improved/diagnostic_output'
...
HL2_JOINT_NAMES = [
    "0_Palm", "1_Wrist", "2_ThumbCMC", "3_ThumbMCP", "4_ThumbIP", "5_ThumbTip",
    "6_IndexMCP", "7_IndexPIP", "8_IndexDIP", "9_IndexTip",
    "10_MiddleMCP", "11_MiddlePIP", "12_MiddleDIP", "13_MiddleTip",
    "14_RingMCP", "15_RingPIP", "16_RingDIP", "17_RingTip",
    "18_PinkyMCP", "19_PinkyPIP", "20_PinkyDIP", "21_PinkyTip",
    "22_Thumb_CMC_rad", "23_Thumb_IP_rad", "24_Palm-ulnar", "25_PinkyMCP-ulnar"  # Not sure about these
]
...
MEDIAPIPE_EDGES_HL2 = [
    (0, 1), (1, 2), (2, 3), (3, 4),  # Thumb (but 0 is Palm not Wrist!)
    (0, 5), (5, 6), (6, 7), (7, 8),  # Index (0=Palm -> wrong!)
...
for frame_idx in [10, 50, 99]:
    ...
    for hand_start, hand_label, color in [(0, 'L', (255, 80, 80)), (52, 'R', (80, 255, 80))]:
        ...
        draw1.text((int(wrist_x)+15, int(wrist_y)-15), f'{hand_label} (HL2 corrected)', fill=(255,255,0), font=font_large)

    draw1.text((10, 10), f'Frame {frame_idx} - HL2 CORRECT skeleton (edges: Wrist=1 as base)', fill=(255,255,255), font=font_large)
    ...
    for hand_start, hand_label, color in [(0, 'L', (255, 80, 80)), (52, 'R', (80, 255, 80))]:
        ...
        wrist_x, wrist_y = joints[1]
        draw2.text((int(wrist_x)+15, int(wrist_y)-15), f'{hand_label} (MediaPipe skeleton)', fill=(255,255,0), font=font_large)

    draw2.text((10, 10), f'Frame {frame_idx} - MediaPipe skeleton on HL2 coords (WRONG if Palm!=Wrist)', fill=(255,255,255), font=font_large)
    ...
    draw3.text((10, 10), f'Frame {frame_idx} - Raw HL2 joint positions (no edges)', fill=(255,255,255), font=font_large)
