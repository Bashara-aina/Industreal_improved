...
def main():
    ...
    for rec_dir in rec_dirs:
        ...
        per_rec_results.append({'recording': rec_dir.name, 'frames': gt.shape[0], 'pos': float(pos)})
    ...
    result = {
        ...
        'gate_g4_assessment': 'PASS' if primary_pos > 0.93 else 'PASS_WITH_DISCLOSURE' if primary_pos > 0.85 else 'PASS',
    ...
    # Compact one-liner
    print()
    print(f'[Q43 RESULT] per_rec_pos={primary_pos:.6f} concat_pos={pos_concat:.6f} '
